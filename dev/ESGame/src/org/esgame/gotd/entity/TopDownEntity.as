package org.esgame.gotd.entity
{
	...
	public class TopDownEntity extends FlxSprite
	{
		...
		public static const ENTITY_SIZE:FlxPoint = new FlxPoint(16, 18); // size in pixels
		...
		public function TopDownEntity(X:Number = 100, Y:Number = 100):void {
			super(X, Y);
			makeGraphic(ENTITY_SIZE.x, ENTITY_SIZE.y, 0xFFFF0000); // use this if you want a generic box graphic by default
			// movement
