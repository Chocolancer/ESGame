package globals 
{
	...
	public class EquipmentCollection 
	{
		...
		public function EquipmentCollection() 
		{
			...
			weaponCollection.BGlaive = new Weapon("Blessed Glaive", "A polearm blessed with the powers of the goddess Yfadna. It was once a weapon wielded by a great hero.", 19, 27, ElementNames.SUN, 1.2);
			...
			armorCollection.LucidGarb = new Armor("Lucid Garb", "A leather garb enchanted with the powers of Lum. Its surface shimmers in the moonlight.", 12, ElementNames.MOON, 1.2);
