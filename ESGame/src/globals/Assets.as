package globals 
{
	...
	public class Assets 
	{
		...
		[Embed(source = "../../assets/sprites/rydia_child.png")] public static var RYDIA_SPRITE:Class;
		...
		// tiles
		[Embed(source = "../../assets/tiles/walls.png")] public static var WALLS_TILE:Class;
		[Embed(source = "../../assets/tiles/floor_wood.png")] public static var FLOORS_TILE:Class;
		[Embed(source = "../../assets/tiles/rtp_tileset.png")] public static var RTP_OBJECTS:Class;
	}
