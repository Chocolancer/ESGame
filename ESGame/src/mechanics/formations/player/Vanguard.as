package mechanics.formations.player 
{
	 ...
	 */
	public class Vanguard extends Formation
	{
		//Y formation with bottom facing outward
		public function Vanguard(width: uint, height: uint) 
		{
			super(4);
			...
			formationy[1] = height / 2;
			formationx[2] = width / 4 * 3;
			formationy[2] = height / 4;
			formationx[3] = width / 4 * 3;
			formationy[3] = height / 4 * 3;
		}
