package org.esgame.gotd.overworld 
{
	...
	import org.flixel.*;
	import org.esgame.gotd.entity.*;
	
	/**
	 * Base class for all levels
	 * @author Cody Sandahl
	 */
	public class TopDownGameLevel extends FlxGroup
	{
		/**
		 * Map
		 */
		 ...
		 */
		public function TopDownGameLevel(state:FlxState, levelSize:FlxPoint, tileSize:FlxPoint):void {
			super();
			this.state = state;
